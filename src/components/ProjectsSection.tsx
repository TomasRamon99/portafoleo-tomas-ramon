            ...
            <div key={idx} className="group relative bg-[#0b1120] rounded-3xl overflow-hidden border border-white/5 flex flex-col md:flex-row hover:border-blue-500/30 transition-colors">
              ...
              <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                ...
                <h3 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                  {project.title}
                  <a href={project.link} target="_blank" rel="noreferrer" className="bg-white/5 p-2 rounded-full hover:bg-blue-600 hover:text-white text-slate-400 transition-colors cursor-pointer opacity-0 group-hover:opacity-100 transform -translate-x-4 group-hover:translate-x-0 duration-300">
